...
void AFighterCharacter::BeginPlay()
{
	...
	if (AbilitySystemComponent && HasAuthority())
	{
		...
		if (ParryReactAbility)
		{
			FGameplayAbilitySpec ParryReactSpec(ParryReactAbility, 1, static_cast<int32>(EAbilityId::Hit_React), this);
			AbilitySystemComponent->GiveAbility(ParryReactSpec);
		}
